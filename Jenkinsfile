pipeline {
  ...
  environment {
    ...
    EXT_USER = 'terrastruct'
    EXT_REPO = 'd2'
    BUILD_VERSION_ARG = 'D2_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-d2-builder'
    CONTAINER_NAME = 'd2-builder'
    DOCKERHUB_IMAGE = 'linuxserver/d2-builder'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/d2-builder'
    PR_DOCKERHUB_IMAGE = 'lspipepr/d2-builder'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='false'
    CI_WEB='false'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-d2-builder/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-d2-builder\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-d2-builder\" \
